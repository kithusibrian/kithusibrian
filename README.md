...
### Full-Stack Developer | Software Engineer | ICT Professional

I build modern, scalable web applications with a focus on clean UI, efficient backend systems, and real-world usability.

I also work in an enterprise ICT environment, gaining hands-on experience in systems, workflows, and production-level tools while continuously growing as a software engineer.

🚀 Open to Full-Stack Developer, Software Engineering, and Graduate Trainee opportunities.
...
JavaScript • Python • SQL • HTML • CSS •Typescript • R 
...
* Work with enterprise ICT systems and workflows
* Solve real-world problems using software
* Continuously learn modern engineering practices (including Machine Learning)
...
GitHub: github.com/briankithusi
